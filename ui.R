  ...
  sidebarLayout(
    sidebarPanel(width = 4,
                 ...
                 wellPanel(style = "background-color: #ffffff;",
                           h4("За"),
                           tags$div("Визуелизација на спорните гласачи од", tags$a(href="http://www.sec.mk/", "списокот објавен од страна на Државната изборна комисија во јули 2016."),tags$br
                                    "Податоците се групирани по општини и по региони. Град Скопје е извдоен посебно од Скопскиот регион. Недостасуваат 6 записи за кои
                                    има вредости NULL за општини во оригиналните податоци."tags$br
